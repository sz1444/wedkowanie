...
import { Home, User as UserIcon, PlusCircle, Zap, BookOpen, LayoutGrid, ShieldCheck, Trophy } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { href: '/fishdex',     icon: BookOpen,   label: 'Rejestr Połowów' },
    ...
    <aside className="hidden md:flex flex-col w-72 bg-white border-r border-slate-100 sticky top-0 h-screen p-6 shadow-sm z-30">
      ...
      <div className="mt-4 mb-3 px-1">
        <div className="flex justify-between items-center mb-1.5">
          ...
          <span className="text-[9px] font-black text-emerald-600 uppercase tracking-widest">{analytics.totalXp} XP</span>
        </div>
      ...
      <div className="p-4 bg-slate-50 rounded-2xl flex items-center gap-3 border border-slate-100">
        <div className="w-9 h-9 bg-emerald-600 text-white rounded-xl flex items-center justify-center font-black text-sm shrink-0">
      ...
      <button
        ...
        className="w-full mt-3 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest text-slate-400 border border-slate-200 hover:bg-red-50 hover:text-red-600 hover:border-red-200 transition-all"
      >
        Wyloguj się
      </button>
    </aside>
